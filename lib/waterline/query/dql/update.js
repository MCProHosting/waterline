...
var sailsEmitter = require('../../utils/sailsEmitter');
...
module.exports = function(criteria, values, cb, broadcast) {
  ...
  createBelongsTo.call(this, valuesObject, function(err) {
    ...
    beforeCallbacks.call(self, valuesObject.values, function(err) {
      ...
      if (broadcast) {
        sailsEmitter.emitUpdate(self.adapter.collection, values.id, valuesObject.values);
      }
    });
  });
};
